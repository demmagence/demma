...
- **Open-Source Projects Grid**: Fully responsive project showcases featuring active repositories — CBT App (Dart), GlowMatch (Dart), Solvera (TypeScript), OmniAgent Studio (TypeScript), Kassa (TypeScript / Python), Eco (Dart / JavaScript), Lost and Found (Dart), and Mories (Kotlin).
